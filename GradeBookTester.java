...
public class GradeBookTester {
	...
	@Test
	public void testSum() {
		assertEquals(55.8, gradebook1.sum(), 0.0001);
		assertEquals(140.7, gradebook2.sum(), 0.0001);
	}

	@Test
	public void testMinimum() {
		assertEquals(15.5, gradebook1.minimum(), 0.001);
		assertEquals(56.4, gradebook2.minimum(), 0.001);
	}
